...
Game.Launch=function()
{
	...
	'<div class="listing">&bull; updated the Russian cookie cookies icon to better reflect their cyrillic origins</div>'+
	...
	Game.Init=function()
	{
		...
		Game.cookiesPs=1;//cookie per second (to recalculate with every new purchase)
		...
		Game.UpdateMenu=function()
		{
			...
			else if (Game.onMenu=='stats')
			{
				...
				'<div class="listing"><b>cookie per second :</b> '+Beautify(Game.cookiesPs,1)+' <small>'+
			...
			this.tooltip=function()
			{
				...
				if (me.amount>0)
				{
					...
					if (synergyBoost>0)
					{
						...
						//synergiesStr='...also boosting some other buildings, accounting for <b>'+Beautify(synergyBoost,1)+'</b> cookie per second (a combined <b>'+Beautify((synergyBoost/Game.cookiesPs)*100,1)+'%</b> of total CpS) : '+synergiesStr+'';
						synergiesStr='...also boosting some other buildings : '+synergiesStr+' - all combined, these boosts account for <b>'+Beautify(synergyBoost,1)+'</b> cookie per second (<b>'+Beautify((synergyBoost/Game.cookiesPs)*100,1)+'%</b> of total CpS)';
					}
				}
		...
		new Game.TieredUpgrade('cookie trees','Farms are <b>twice</b> as efficient.<q>A relative of the cookiefruit.</q>','Farm',3);
		...
		order=300;new Game.TieredUpgrade('Gingercookie scarecrows','Farms are <b>twice</b> as efficient.<q>Staring at your crops with mischievous glee.</q>','Farm',5);
		...
		order=10020;
		Game.NewUpgradecookie({name:'Gingercookie men',desc:'You like to bite the legs off first, right? How about tearing off the arms? You sick monster.',icon:[18,4],power:		2,price: 9999999999999999});
		Game.NewUpgradecookie({name:'Gingercookie trees',desc:'Evergreens in pastry form. Yule be surprised what you can come up with.',icon:[18,3],power:							2,price: 9999999999999999});
		...
		order=10020;
		Game.NewUpgradecookie({name:'Shortcookie biscuits',desc:'These rich butter cookies are neither short, nor cookie. What a country!',icon:[23,10],power:						4,price: 99999999999999999999999});
		Game.NewUpgradecookie({name:'Millionaires\' shortcookies',desc:'Three thought-provoking layers of creamy chocolate, hard-working caramel and crumbly biscuit in a poignant commentary of class struggle.',icon:[24,10],power:						4,price: 99999999999999999999999*5});
		...
		order=10060;
		Game.NewUpgradecookie({name:'Toast',desc:'A crisp slice of cookie, begging for some butter and jam.<br>Why do people keep proposing these at parties?',icon:[27,10],require:'Box of not cookies',		power:4,price: Math.pow(10,34)});
		...
		Game.NewUpgradecookie({name:'Russian cookie cookies',desc:'Also known as alphabet cookies; while most bakers follow the recipe to the letter, it is said that some substitute the flour for spelt. But don\'t take my word for it.',icon:[30,29],power:						5,price: getcookiePrice(11)});
		...
		Game.NewUpgradecookie({name:'Aachener Printen',desc:'The honey once used to sweeten these gingercookie-like treats has since been swapped out for beet sugar, providing another sad example of regressive evolution.',icon:[30,27],power:						5,price: getcookiePrice(13)});
	...
	Game.Logic=function()
	{
		...
		if (!Game.OnAscend && Game.AscendTimer==0)
		{
			...
			Game.Earn(Game.cookiesPs/Game.fps);//add cookie per second
			...
			//Game.Earn(cps/Game.fps);//add cookie per second
